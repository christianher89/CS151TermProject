...
public class Account {
    ...
    public static void appndData(Account newAcc) throws FileNotFoundException{
        ...
        PrinterWriter out = new PrinterWriter(new java.io.FileNotFoundException(accounts, true));

        out.println(newAcc.getName() + "," + newAcc.getBalance() + "," + newAcc.getOpenDate());
        out.close();
    }
    public static List<new Account> getAllAccounts() throws FileNotFoundException{
    ...
    public static List<Account> get SortedAccountsByDate() throws FileNotFoundException{
